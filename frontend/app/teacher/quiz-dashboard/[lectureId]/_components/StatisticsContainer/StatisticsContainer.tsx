...
// 하드코딩 테스트 데이터 (타입 맞춰서 선언)
const mockDetailData: fetchQuizDetailStatResult = [
  {
  ...
  },
  {
    ...
    type: "shortAnswer",
    top3Answers: [
      { answer: "합성", rate: 18.18 },
      { answer: "첨가 규칙", rate: 18.18 },
      { answer: "첨가규칙", rate: 18.18 },
    ],
    etcAnswers: [
      "R1(A, B), R2(A, C)",
      "첨가",
  ...
  },
  {
    ...
    type: "shortAnswer",
    top3Answers: [
      { answer: "R1(A,B)", rate: 36.36 },
      { answer: "R1(A,C)", rate: 27.27 },
      { answer: "첨가 규칙", rate: 18.18 },
    ],
    etcAnswers: ["R1(A,A)", "R1(C,A)"],
  },
];
